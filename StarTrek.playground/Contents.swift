...
//should only be 2
let firstOfficerVulcans = firstOfficers.keys.filter{vulcanOfficers.contains($0)}
print(firstOfficerVulcans)
...
let shorterThan5 = firstOfficerVulcans.filter{ officerName in officerName.count < 5}
print(shorterThan5.count)
